...
public class MemberDAO {
    ...
    private String generateMemberId() {
        ...
        try (Connection connection = getConnection();
            ...
            if (rs.next()) {
                ...
                System.out.println("Max member ID found: " + maxMemberId);
    ...
    public boolean addMember(Member member) {
        ...
        try (Connection connection = getConnection();
            ...
            if (rowsAffected > 0) {
                System.out.println("Member added successfully: " + memberId);
    ...
    public List<Member> getAllActiveMembers() {
        ...
        try (Connection connection = getConnection();
            ...
            while (rs.next()) {
                ...
                members.add(member);
                System.out.println("Found member: " + member.getMemberId() + " - " + member.getName());
            }
            
            System.out.println("Total active members found: " + count);
