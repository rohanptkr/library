    ...
    <div class="container">
        ...
        <main>
            <div class="desktop-tabs">
                ...
                <a href="members?action=new" class="desktop-tab active">👤 Register Member</a>
            ...
            <div class="form-container">
                <form action="members" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="memberId" name="memberId" required placeholder="Enter unique member ID">
                    </div>
